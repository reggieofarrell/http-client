...
description: Investigate and fix SonarQube or SonarJS findings, quality-gate failures, duplicated-code reports, security hotspots, or server/local rule drift. Not for an ordinary lint error with no Sonar finding.
---
