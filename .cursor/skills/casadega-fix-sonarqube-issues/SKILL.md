...
description: Investigate and fix SonarQube findings in a repository that uses Casadega TypeScript Repo Tooling. Use for local Sonar precheck failures, quality-gate issues, duplicated code, security hotspots, or host/token diagnostics. Do not use for ordinary lint errors without a Sonar finding.
---
