---
name: cut-release
description: Preview and prepare an @reggieofarrell/http-client semver release through a protected release branch, then publish it from merged main through a GitHub Release and npm OIDC. Always stop for explicit version approval before writing the release commit.
---
# Cut a release
