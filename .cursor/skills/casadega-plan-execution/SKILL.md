...
description: Execute a durable implementation plan completely, record deviations and evidence as work happens, falsify regression tests, and prepare the result for independent review.
---
