...
description: Independently review a plan-backed implementation, verify claims and gates instead of trusting implementer notes, mutation-test critical coverage, and produce an actionable report.
---
