...
description: >-
  Choose, validate, and create a repository work branch using a Conventional
  Commit prefix, an available issue or card identifier, and a descriptive
  kebab-case slug. Use when starting work on a new branch or correcting a
  proposed branch name; not for protected or platform-managed branches.
---
