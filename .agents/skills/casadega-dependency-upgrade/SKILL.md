...
description: >-
  Upgrade a JavaScript or TypeScript dependency deliberately by reviewing every
  intervening release, verifying affected usage, respecting cooldown policy, and
  running the owning repository gate.
---
