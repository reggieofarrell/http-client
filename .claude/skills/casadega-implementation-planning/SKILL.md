...
description: >-
  Create an evidence-backed implementation handoff for a later session or
  different implementer when the plan must survive a context boundary; not for
  ordinary in-session planning.
---
