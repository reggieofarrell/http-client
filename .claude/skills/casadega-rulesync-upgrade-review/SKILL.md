...
description: >-
  Review a RuleSync CLI or shared-source upgrade by comparing generated output
  with its previous baseline and proving that every configured target still
  receives the intended policy.
---
